...
export const createBoard = async () => {
    const res = await fetch('http://do-stuff.s3-website-us-west-1.amazonaws.com/boards', { method: 'POST' });
    const payload = await res.json();
    return payload._id;
};

export const loadBoard = (currentBoard) => {
    return fetch(`http://do-stuff.s3-website-us-west-1.amazonaws.com/boards/${currentBoard}`)
        .then(res => { 
